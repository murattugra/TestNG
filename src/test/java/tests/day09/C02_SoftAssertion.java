...
public class C02_SoftAssertion {
    ...
    public void test01(){
        ...
        driver.navigate().back();//guvenlid egilyazisini gecer
        ...
        softAssert.assertAll();//Buraya kadarki testlerden Failed olan varsa bu satirdan sonra calismaz ve rapor verir
    }
